...
test.describe('Navigation and UI', () => {
  ...
  test('should have working navigation in demo mode', async ({ page }) => {
    ...
    await expect(page.getByText('Step 1/4')).not.toBeVisible();
  ...
  test('should interact with task in demo mode', async ({ page }) => {
    ...
    // Check for the celebration component or updated UI state
    // Since toast might be transient, just verify button was clicked successfully
