...
const celebrationConfigs: Record<CelebrationType, CelebrationConfig> = {
  ...
  task_completed: {
    title: "MashaAllah!",
    subtitle: "Task completed with excellence!",
    emoji: "🎉",
    confettiType: 'cannon',
    duration: 3000,
  },
  streak_milestone: {
    title: "SubhanAllah! 🔥",
    subtitle: "Keep the blessed momentum going!",
    emoji: "⚡",
  ...
  first_task: {
    title: "Alhamdulillah!",
    subtitle: "Your blessed journey begins now!",
    emoji: "🌟",
    confettiType: 'stars',
    duration: 3000,
  },
  hard_task: {
    title: "MashaAllah Champion!",
    subtitle: "You conquered a tough one with Ihsan!",
    emoji: "💎",
    confettiType: 'fireworks',
    duration: 4000,
  },
  ...
  weekly_goal: {
    title: "Alhamdulillah!",
    subtitle: "Weekly goal achieved with barakah!",
    emoji: "🎊",
    confettiType: 'fireworks',
    duration: 4000,
  },
