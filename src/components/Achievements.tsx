...
export const BADGES: Record<BadgeType, BadgeConfig> = {
  first_task: {
    name: 'First Steps',
    description: 'Bismillah! Completed your first task',
    icon: '🌟',
  ...
  hard_worker: {
    name: 'Ihsan Champion',
    description: 'Excellence in 10 hard tasks',
    icon: '💪',
  ...
  streak_7: {
    name: 'Week Warrior',
    description: 'MashaAllah! 7 day streak',
    icon: '🔥',
  ...
  streak_30: {
    name: 'Monthly Legend',
    description: 'SubhanAllah! 30 day streak',
    icon: '⚡',
  ...
  team_player: {
    ...
    description: 'Helped verify 5 tasks - JazakAllah!',
    icon: '🤝',
  ...
  early_bird: {
    name: 'Fajr Finisher',
    description: 'Completed tasks in early morning',
    icon: '🌅',
  ...
  night_owl: {
    name: 'Qiyam Worker',
    description: 'Completed tasks in late night',
    icon: '🌙',
  ...
  perfectionist: {
    ...
    description: 'All tasks verified first try - Ihsan!',
    icon: '✨',
    color: 'from-emerald-400 to-teal-600',
    rarity: 'epic',
  },
  washroom_warrior: {
    name: 'Purity Champion',
    description: 'Cleaned washroom 10 times - Taharah!',
    icon: '🚿',
    color: 'from-blue-400 to-blue-600',
    rarity: 'rare',
  },
  kitchen_king: {
    name: 'Kitchen Khalifa',
  ...
  consistent: {
    name: 'Istiqamah Star',
    description: 'Consistent tasks for a month',
    icon: '📊',
